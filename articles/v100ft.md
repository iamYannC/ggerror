# stat_error() and sign_aware + demo
...
![](v100ft_files/figure-html/stat-ci-1.png)

*Both `mean_ci` and `mean_se` accept `na.rm` as an argument.* *`mean_ci`
also accepts `conf.int`, default is 0.95.*
...
![](v100ft_files/figure-html/stat-custom-1.png)
...
![](v100ft_files/figure-html/residuals-plot-1.png)

\*Since both axes are numeric, `ggerror` can’t infer the orientation
itself, so we have to pass it

...
- Summary layers from raw data with
  [`stat_error()`](https://iamyannc.github.io/ggerror/reference/stat_error.md)
...
![](reference/figures/README-default-plot-1.png)
...
![](reference/figures/README-pointrange-wrapper-1.png)
...
![](reference/figures/README-one-side-plot-1.png)

## Summaries from raw data with `stat_error()`

When you do not want to pre-compute the bounds yourself,
[`stat_error()`](https://iamyannc.github.io/ggerror/reference/stat_error.md)
...
![](reference/figures/README-error-summary-plot-1.png)
...
![](reference/figures/README-custom-summary-plot-1.png)
...
![](reference/figures/README-residual-plot-1.png)

...
<summary>More on <code>airquality</code> (click to expand, or type
<code>?airquality</code>)</summary>
...
function and it computes `y`, `ymin`, `ymax` per group. Regardless of
the orientation of your plot, the summary function **must return a data
...
`...` argument. In this example, to multiply the error by 2, you'd write

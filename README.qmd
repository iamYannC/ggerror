...
asymmetric and one-sided cases. `ggerror` infers orientation and lets you style each side independently.
It computes summaries from raw data with `stat_error()`, and draws signed
quantities such as residuals with `sign_aware`.

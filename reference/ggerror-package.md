...
\`error_neg\` and \`error_pos\` for asymmetric cases, with full control
over aesthetics per side, such as color, width etc...

## See also

Useful links:

- <https://iamyannc.github.io/ggerror/>

- Report bugs at <https://github.com/iamYannC/ggerror/issues>
